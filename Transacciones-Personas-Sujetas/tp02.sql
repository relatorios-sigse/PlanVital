SELECT
    ...
    FROM
        (SELECT
            ...
            TP02.uniddeci AS Unidades,
            TP02.precunitdeci AS Precio_Unitario,
            TP02.valotota AS Valor_total,
            CASE 
            ...
            TP02.tirdeci AS TIR,
            TP02.plazinst AS Plazo_del_Instrumento,
            MONE.descmone AS Moneda_de_Emision,
            TP02.precunitmonedec AS Precio_Unitario_Moneda_Emision,
            TP02.fechatransaccio AS Fecha_de_Transacción,
            ...
            TP02.porcvalopartext AS porc_valor_par_extranjero,
            TP02.tirextrdeci AS tir_extranjera,
